...
- Within the opening, make clear who the piece is for, the problem or decision it covers, and the payoff.
...
- Treat `ready to publish unless user feedback` as the default end state for substantial draft work once only optional polish remains.
